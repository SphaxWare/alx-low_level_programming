...
/**
 * slist_set - sets a new node before the given node.
...
/**
 * slist_set_end - sets node at the end of the sorted list
 * @ht: sorted hash table.
...
/**
 * shash_table_set - add or update an element to a sorted hash table.
...
/**
 * shash_table_print - prints key/value sorted hash table order.
 * @ht:sorted hash table.
 */
...
/**
 * shash_table_print_rev - prints sorted key/value in reverse.
 * @ht: sorted hash table.
 */
